namespace TechBlog.NewsManager.Tests.IntegrationTests.Fixtures
{
    public static class IntegrationTestsHelper
    {
        ...
        public const string ValidBlogNewTitle = "Fake title";
        public const string ValidBlogNewDescription= "Fake description";
        public const string ValidBlogNewBody= "Fake body";
        public const string ValidBlogNewTags= "fake;tag";

        public const string CreateDatabaseScript = @"
            BEGIN TRANSACTION;
