...
namespace TechBlog.NewsManager.Tests.IntegrationTests.BlogNews
{
    ...
    public class UpdateBlogNewTests
    {
        ...
        public UpdateBlogNewTests(IntegrationTestsFixture fixture)
        {
            _fixture = fixture;
        }
        ...
        public async Task RequestWithoutAccessKey_ShouldReturnUnauthorized()
        {
            ...
            //Act
            var response = await _fixture.Client.DeleteAsync(UpdateBlogNewHandler.Route.Replace("{id:guid}", id.ToString()));
